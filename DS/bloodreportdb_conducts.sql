...
CREATE TABLE `conducts` (
  ...
  `TID` int NOT NULL,
  PRIMARY KEY (`LID`,`TID`),
  KEY `kk_testID_idx` (`TID`),
  CONSTRAINT `fk_labID` FOREIGN KEY (`LID`) REFERENCES `lab` (`LabID`),
  CONSTRAINT `kk_testID` FOREIGN KEY (`TID`) REFERENCES `test` (`TestID`)
...
INSERT INTO `conducts` VALUES (121,131),(124,131),(122,132),(125,132),(121,133),(122,133),(122,134),(121,135),(123,135),(124,135),(125,135);
